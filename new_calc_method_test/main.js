...
// Variables for Mandelbrot shaders
let mandelbrotShaderProgram;

// Fetch and initialize shaders
let vertexShaderSource, mandelbrotFragmentShaderSource;
...
.then(shaders => {
    [vertexShaderSource, mandelbrotFragmentShaderSource,] = shaders;
...
const renderMandelbrot = () => {
    ...
    // mandelbrotGl.uniform1i(themeLocation, currentTheme);s
